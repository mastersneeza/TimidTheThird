...
int disassembleInstruction(Block* block, int offset) {
    ...
    switch (currentInstruction) {
        ...
        case OP_DEFINE_GLOBAL: return constantInstruction("OP_DEFINE_GLOBAL", block, offset);
        case OP_GET_GLOBAL: return constantInstruction("OP_GET_GLOBAL", block, offset);
        case OP_SET_GLOBAL: return constantInstruction("OP_SET_GLOBAL", block, offset);
